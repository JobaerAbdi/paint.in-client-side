  ...
  return (
    <div className='md:flex md:mx-16 lg:mx-32 my-2 px-10 shadow-xl '>
        <div className='basis-1/2 my-10 mr-5'>
            ...
            <div className='w-fit mx-auto'><button className=' my-5 xl:mt-12 text-white px-2 md:px-10 text-xs md:text-lg btn btn-secondary btn-xs md:btn-md'>See More</button></div>
