                            ...
                            <>
                                <form onSubmit={handleAddClass}>
                                    ...
                                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 my-5'>
                                        <input name="productName" type="text" placeholder="Class title" className="input input-ghost w-full  input-bordered" required />
                                        <input name="photoUrl" type="text" placeholder="Input class PhotoUrl" className="input input-ghost w-full  input-bordered" required />
                                        <input name="originalPrice" type="text" placeholder="Class fee" className="input input-ghost w-full  input-bordered" required />
                                    ...
                                    <textarea name="description" className="textarea textarea-bordered h-24 w-full" placeholder="Class description" required></textarea>
